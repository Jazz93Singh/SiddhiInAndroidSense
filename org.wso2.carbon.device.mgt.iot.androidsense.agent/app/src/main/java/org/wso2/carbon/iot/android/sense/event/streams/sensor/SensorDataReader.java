...
import org.wso2.edgeanalyticsservice.SiddhiActivity;
...
public class SensorDataReader extends DataReader implements SensorEventListener {
    ...
    private static boolean isSiddhiStarted =false;
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if(event.values.length>0 && isSiddhiStarted){
            SiddhiActivity.getData(event);
        }
    }
    ...
    public static synchronized void setStarted(boolean signal){
        isSiddhiStarted = signal;
    }
}
